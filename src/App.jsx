  ...
  return (
    <div className='h-[100dvh] flex flex-col items-center justify-center bg-primary'>
      <img
        ...
        height={52}
      />
      <h1 className='font-bold text-xl'>FIELD SERVICE REPORT</h1>
      <form
        className='flex flex-col gap-3 p-8 bg-primary'
        onSubmit={onSubmit}
        ...
        <div className='flex gap-4'>
          ...
          <select
            ...
            ref={ref}
            defaultValue={d.toLocaleString('default', {
              month: 'long',
            })}>
        ...
        <div
          className={`flex flex-col ${
            watch(formName.pioneer) !== 'Yes' ? 'invisible' : ''
          }`}>
